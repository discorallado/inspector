...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->discoverPages(in: module_path('Inspeccion', 'app/Filament/Pages'), for: 'Modules\Inspeccion\Filament\Pages')
            ->pages([
                Dashboard::class,
            ])
            ->discoverWidgets(in: app_path('Filament/Widgets'), for: 'App\Filament\Widgets')
            ->discoverWidgets(in: module_path('Inspeccion', 'app/Filament/Widgets'), for: 'Modules\Inspeccion\Filament\Widgets')
            ->widgets([
                AccountWidget::class,
