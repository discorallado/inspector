...
return [
     ...
     *
     * Custom (no la del paquete): acá cualquiera que vea el Tablero puede
     * comentar, borrar el propio comentario, o super_admin borra cualquiera
     * (ver Modules\Inspeccion\Policies\ComentarioPolicy y el ADR de
     * comentarios).
     */
    'model_policy' => \Modules\Inspeccion\Policies\ComentarioPolicy::class,
